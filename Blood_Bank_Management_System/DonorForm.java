...
//jp1.add(new JLabel("DONOR REGISTRATION FORM"), BorderLayout.NORTH);
jp1.setLayout(null);
...
hb= new JLabel("Haemoglobin Content :");
age= new JLabel("Age :");
sex= new JLabel("Sex :");
...
donor_id.setLabelFor( jtf1 );
donor_id.setDisplayedMnemonic( 'D' );

jtf2=new JTextField(25);
name.setLabelFor( jtf2 );
...
jp1.add(cnt);jp1.add(jtf8);jp1.add(ok);ok.addActionListener(this);jp1.add(back);back.addActionListener(this);
...
jp2.add(doc);jp2.add(jtf17);jp2.add(submit);submit.addActionListener(this);
add(jp2);
...
JOptionPane.showMessageDialog(null, "Record of Voluntary Donor Inserted");
jtf1.setText("");
jtf2.setText("");
jtf3.setText("");
jtf4.setText("");
...
JOptionPane.showMessageDialog(null,"Record of Replacement Donor & Recipient Inserted");
jtf1.setText("");
jtf2.setText("");
jtf3.setText("");
jtf4.setText("");
...
else if(se.getSQLState()=="23")
{ JOptionPane.showMessageDialog(null, "Pouch Already Issued");
jtf11.setText("");jtf12.setText("");
}
...
public class DonorForm {
  ...
  public static void main(String args[]){
   Donor d=new Donor("INDU BLOOD BANK");
d.setSize(1500,800);
 d.setVisible(true);
